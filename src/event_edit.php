...
<body>
  ...
  <div class="bg-gray-100 p-4">
    <div>
      <h2 class="text-2xl mt-3 mb-3 font-bold">イベント編集</h2>
    </div>
  </div>
  <div class="change">
    <form action="" method="post" id="postForm" class="p-3">
      <p class="text-xl pt-4 pb-4">イベント名</p>
      <input type="text" name="event_name" class="w-full" value="<?= $event['name'] ?>">
      <p class="text-xl pt-5 pb-4">開始日時</p>
      <input type="datetime-local" name="event_start" class="w-full" value="<?= $event['start_at'] ?>">
      <p class="text-xl pt-5 pb-4">終了日時</p>
      <input type="datetime-local" name="event_end" class="w-full" value="<?= $event['end_at'] ?>">
      <p class="text-xl pt-5 pb-4">イベント詳細</p>
      <input type="text" name="event_detail" class="w-full" value="<?= $event['detail'] ?>">
